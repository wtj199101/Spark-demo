 ...
 * {{{
 * bin/run-cn.spark.example org.apache.spark.example.mllib.Correlations
 * }}}
...
object Correlations {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("Correlations") {
      head("Correlations: an cn.spark.example app for computing correlations")
      opt[String]("input")
      ...
      note(
        ...
        |
        | bin/spark-submit --class org.apache.spark.example.mllib.Correlations \
