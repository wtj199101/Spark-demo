...
/**
 * An cn.spark.example naive Bayes app. Run with
 * {{{
 * ./bin/run-cn.spark.example org.apache.spark.example.mllib.SparseNaiveBayes [options] <input>
 * }}}
...
object SparseNaiveBayes {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("SparseNaiveBayes") {
      head("SparseNaiveBayes: an cn.spark.example naive Bayes app for LIBSVM data.")
