...
/**
 * An cn.spark.example Power Iteration Clustering http://www.icml2010.org/papers/387.pdf app.
 ...
 * Run with
 * {{{
 * ./bin/run-cn.spark.example mllib.PowerIterationClusteringExample [options]
 *
 ...
 *
 * ./bin/run-cn.spark.example mllib.PowerIterationClusteringExample -k 3 --n 30 --maxIterations 15
 *
...
object PowerIterationClusteringExample {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("PowerIterationClusteringExample") {
      head("PowerIterationClusteringExample: an cn.spark.example PIC app using concentric circles.")
      opt[Int]('k', "k")
