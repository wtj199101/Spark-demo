...
/**
 * An cn.spark.example runner for Gradient Boosting using decision trees as weak learners. Run with
 * {{{
 * ./bin/run-cn.spark.example mllib.GradientBoostedTreesRunner [options]
 * }}}
...
object GradientBoostedTreesRunner {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("GradientBoostedTrees") {
      head("GradientBoostedTrees: an cn.spark.example decision tree app.")
      opt[String]("algo")
