...
/**
 * An cn.spark.example k-means app. Run with
 * {{{
 * ./bin/run-cn.spark.example org.apache.spark.example.mllib.DenseKMeans [options] <input>
 * }}}
...
object DenseKMeans {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("DenseKMeans") {
      head("DenseKMeans: an cn.spark.example k-means app for dense data.")
      opt[Int]('k', "k")
        .required()
