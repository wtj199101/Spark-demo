...
/**
 * A simple cn.spark.example demonstrating model selection using CrossValidator.
 * This cn.spark.example also demonstrates how Pipelines are Estimators.
 *
 * This cn.spark.example uses the Java bean classes {@link org.apache.spark.examples.ml.LabeledDocument} and
 * {@link org.apache.spark.examples.ml.Document} defined in the Scala cn.spark.example
 * {@link org.apache.spark.examples.ml.SimpleTextClassificationPipeline}.
 *
 * Run with
 * <pre>
 * bin/run-cn.spark.example ml.JavaCrossValidatorExample
 * </pre>
 */
