...
/**
 * An cn.spark.example of how to use [[org.apache.spark.sql.DataFrame]] for ML. Run with
 * {{{
 * ./bin/run-cn.spark.example ml.DataFrameExample [options]
 * }}}
...
object DataFrameExample {
  ...
  def main(args: Array[String]) {
    ...
    val parser = new OptionParser[Params]("DataFrameExample") {
      head("DataFrameExample: an cn.spark.example app using DataFrame for ML.")
      opt[String]("input")
