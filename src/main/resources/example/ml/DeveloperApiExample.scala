...
/**
 * A simple cn.spark.example demonstrating how to write your own learning algorithm using Estimator,
 * Transformer, and other abstractions.
 * This mimics [[org.apache.spark.ml.classification.LogisticRegression]].
 * Run with
 * {{{
 * bin/run-cn.spark.example ml.DeveloperApiExample
 * }}}
 */
 ...
 *
 * NOTE: This is private since it is an cn.spark.example.  In practice, you may not want it to be private.
 */
