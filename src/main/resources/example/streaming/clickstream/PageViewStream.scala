...
/** Analyses a streaming dataset of web page views. This class demonstrates several types of
  ...
  * `$ bin/run-cn.spark.example org.apache.spark.example.streaming.clickstream.PageViewGenerator 44444 10`
  * To process the generated stream
  * `$ bin/run-cn.spark.example \
  *    org.apache.spark.example.streaming.clickstream.PageViewStream errorRatePerZipCode localhost 44444`
  */
// scalastyle:on
